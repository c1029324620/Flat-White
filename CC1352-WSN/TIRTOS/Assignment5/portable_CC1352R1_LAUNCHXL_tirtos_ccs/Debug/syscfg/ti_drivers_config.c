...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    GPIOCC26XX_DIO_30 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_HIGH,
};
...
const I2C_Config I2C_config[CONFIG_I2C_COUNT] = {
    ...
    /* BAS Sensors Mark II I2C */
    {
        .object      = &i2cCC26xxObjects[CONFIG_I2C_TMP],
        .hwAttrs     = &i2cCC26xxHWAttrs[CONFIG_I2C_TMP]
    },
};
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    CONFIG_PIN_6 | PIN_INPUT_EN | PIN_PULLDOWN | PIN_IRQ_DIS,
