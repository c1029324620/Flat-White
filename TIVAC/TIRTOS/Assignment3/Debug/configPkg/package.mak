...
.dlls,em4f .dlls: Assignment3.pem4f

-include package/cfg/Assignment3_pem4f.mak
-include package/cfg/Assignment3_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Assignment3_pem4f.dep
endif
Assignment3.pem4f: package/cfg/Assignment3_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Assignment3.pem4f package/cfg/Assignment3_pem4f.c: .libraries,em4f
endif

package/cfg/Assignment3_pem4f.c package/cfg/Assignment3_pem4f.h package/cfg/Assignment3_pem4f.xdl: override _PROG_NAME := Assignment3.xem4f
package/cfg/Assignment3_pem4f.c: package/cfg/Assignment3_pem4f.cfg
package/cfg/Assignment3_pem4f.xdc.inc: package/cfg/Assignment3_pem4f.xdl
package/cfg/Assignment3_pem4f.xdl package/cfg/Assignment3_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Assignment3_pem4f.cfg
	-$(RM) package/cfg/Assignment3_pem4f.dep
	-$(RM) package/cfg/Assignment3_pem4f.c
	-$(RM) package/cfg/Assignment3_pem4f.xdc.inc

clean,em4f::
	-$(RM) Assignment3.pem4f
.executables,em4f .executables: Assignment3.xem4f

Assignment3.xem4f: |Assignment3.pem4f

-include package/cfg/Assignment3.xem4f.mak
Assignment3.xem4f: package/cfg/Assignment3_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Assignment3_pem4f.oem4f   package/cfg/Assignment3_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Assignment3.xem4f: export C_DIR=
Assignment3.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Assignment3.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Assignment3.test test,em4f test: Assignment3.xem4f.test

Assignment3.xem4f.test:: Assignment3.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Assignment3.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Assignment3.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Assignment3.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) Assignment3.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Assignment3_pem4f.oem4f,copy : package/cfg/Assignment3_pem4f.oem4f
Assignment3_pem4f.sem4f,copy : package/cfg/Assignment3_pem4f.sem4f
