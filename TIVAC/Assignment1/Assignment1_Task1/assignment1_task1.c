...
void GPIOF4IntHandler(void)
{
    ...
    GPIOPinWrite(GPIO_PORTF_BASE,GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, status);
}
...
int main(void) {
    ...
    GPIOIntRegister(GPIO_PORTF_BASE, GPIOF4IntHandler); //register hanndler function for port F
    GPIOIntTypeSet(GPIO_PORTF_BASE, GPIO_PIN_4, GPIO_FALLING_EDGE); //PF4 for falling edge trigger.
